...
import { TableRow, TableCell, Chip, useTheme, alpha, IconButton, Box } from "@mui/material";
import { Delete, Edit } from "@mui/icons-material";
import { calculateAge } from "../../utils";
import EditQueueDialog from "../../queues/QueueTable/EditQueueDialog";
const PodRow = ({ pod, getStatusColor, onPodClick, handleOpenDeleteDialog, onPodUpdate }) => {
    ...
    return (
        <>
                ...
                <TableCell sx={{ padding: "16px 24px" }}>
                    <Box display="flex" alignItems="center" gap={2}>
                        ...
                        <IconButton
                            onClick={(e) => {
                                e.stopPropagation();
                                handleOpenDeleteDialog(pod.metadata.name);
                            }}
                            size="small"
                            sx={{
            ...
            <EditQueueDialog
                ...
                queue={pod} // Passing pod instead of queue
