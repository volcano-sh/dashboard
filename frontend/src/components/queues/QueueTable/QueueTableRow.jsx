...
const QueueTableRow = ({
    ...
    handleOpenEditDialog, // Ensure this prop is passed to the component
}) => {
            ...
            <TableCell sx={{ padding: "16px 24px" }}>
                <Box display="flex" alignItems="center" gap={2}>
                    <IconButton
                        onClick={(e) => {
                            e.stopPropagation();
                            handleOpenEditDialog(queue.metadata.name);
                        }}
                        size="small"
                        sx={{
                    ...
                    <IconButton
                        ...
                        size="small"
                        sx={{
                            color: theme.palette.error.main, // Error color for delete
                            "&:hover": {
                                backgroundColor: alpha(
