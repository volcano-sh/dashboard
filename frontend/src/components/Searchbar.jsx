          ...
          <Row className="align-items-center g-4">
            <Col xs={12} md={6} lg={5} xl={4}>
              <div className="position-relative">
                <InputGroup className="border rounded-pill overflow-hidden shadow-sm bg-white" style={{ height: '45px' }}>
                  <Button 
                    ...
                    style={{ height: '100%' }}
                  >
                    <FontAwesomeIcon icon={faSearch} className="me-2" style={{ color: '#dc3545' }} />
                    {isRefreshing && (
            ...
            <Col xs={12} md={6} lg={7} xl={8} className="d-flex justify-content-md-end">
              <Button 
                ...
                disabled={isRefreshing}
                style={{ transition: 'all 0.3s ease', height: '45px' }}
              >
                <FontAwesomeIcon icon={faSyncAlt} className="me-2" spin={isRefreshing} />
                <span>{isRefreshing ? 'Refreshing...' : refreshLabel}</span>
              </Button>
            </Col>
          </Row>
        </Container>
