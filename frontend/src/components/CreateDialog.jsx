...
const CreateDialog = ({
    ...
    const validate = () => {
        ...
        if (!queueData.name.trim()) {
            newErrors.name = t("createDialog.validation.nameRequired", { type: resourceType });
        }

        if (isPod) {
            if (!queueData.containerName.trim()) {
                newErrors.containerName = t("createDialog.validation.containerNameRequired");
            }
            if (!queueData.image.trim()) {
                newErrors.image = t("createDialog.validation.containerImageRequired");
            }
            if (
                ...
                newErrors.containerPort =
                    t("createDialog.validation.containerPortRequired");
            }
        } else {
            // Queue validation
            if (
                ...
                newErrors.weight = t("createDialog.validation.weightRequired");
            }
        }
        ...
        >
            ...
            >
                <Typography sx={{ fontWeight: 500 }}>
                    {t("createDialog.resourceSection", { section: section.charAt(0).toUpperCase() + section.slice(1) })}
                </Typography>
            </AccordionSummary>
            <AccordionDetails>
