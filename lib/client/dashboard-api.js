...
export const fetchPod = async (namespace, name) => {
    const response = await axios.get(`/api/pods/${namespace}/${name}`);
    return response.data;
};

export const fetchPodLogs = async (namespace, name, params = {}) => {
    const response = await axios.get(`/api/pods/${namespace}/${name}/logs`, {
        params,
        responseType: "text",
    });
    return response.data;
...
export const fetchPodEvents = async (namespace, name) => {
    const response = await axios.get(`/api/pods/${namespace}/${name}/events`);
    return response.data;
};

export const deletePod = async (namespace, name) => {
    const response = await axios.delete(`/api/pods/${namespace}/${name}`);
    return response.data;
};
...
export const fetchClusterInfo = async () => {
    const response = await axios.get("/api/cluster-info");
    return response.data;
};
